...
provided by content collections, lets use zod and define a TypeScript-first schema for our blog post frontmatter.
...
use remark with its math and katex plugins to parse LaTeX snippets and render them as SVGs. Simply run
...
names, line highlighting, and copy buttons. To do this, I used [Expressive Code](). We can add Expressive Code to our
